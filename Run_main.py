# Runs main.cpp and plots 

import os

os.system('g++ main.cpp interacting_case.cpp -o main.o -O2 -I /Users/harald/Documents/GitHub/QtProjects/FYS3150_Project_2\ /usr/local/include -L/usr/local/lib -larmadillo -lblas -llapack')
os.system('./main.o')
